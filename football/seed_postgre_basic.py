...
def seed() -> None:
    ...
    with Session(engine) as session:
        ...
        # flush() 아직 commit은 하지 않았지만, 현재 세션에 쌓인 INSERT 를 DB로 보낸다
        ...
        # Performances는 player_id로 Player를 참조한다.
        performances = [
            models.Performance(

...
st.header('포켓몬')
st.image(img1, width=400, caption='메타몽, 피카츄, 이상해씨, 꼬부기, 잠만보')

st.header('피카츄')
st.image(img2, width=400, caption='피카츄')

# 5. 컬럼 레이아웃 (세로 단어 2개)
col1, col2 = st.columns(2)
with col1:
    st.header('포켓몬')
    st.image(img1, width=300, caption='메타몽, 피카츄, 이상해씨, 꼬부기, 잠만보')

with col2:
    st.header('피카츄')
    st.image(img2, width=300, caption='피카츄')

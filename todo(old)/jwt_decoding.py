...
token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxMCwiZXhwIjoxNzg2MzQwOTE0fQ.kpv-6le2PZzgl8C3K_Zk6mff-cwTL7-eAZcpQ6JOtT8'
...
def decode(b64: str):
    ...
    decode = base64.urlsafe_b64decode(padded)
    return json.loads(decode) # 디코딩한 바이트를 JSON(dict)으로 변환
